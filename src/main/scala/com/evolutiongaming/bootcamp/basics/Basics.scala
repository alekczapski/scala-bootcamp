...
object Basics {
  ...
  def helloMethod(name: String): String = f"Hello, $name!"
  ...
  val helloFunction: String => String = (name: String) => f"Hello, $name!"
  ...
  val allEitherUnitBooleans: Set[Either[Unit, Boolean]] = Set(Left(None), Right(true), Right(false))
  ...
  val allTupleBooleanBooleans: Set[(Boolean, Boolean)] = Set((true, false), (true, true), (false, true), (false, false))
